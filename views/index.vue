<html lang="en">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/popupable@latest/dist/popupable.min.css" rel="stylesheet">
  </head>
  <body :class="{ 'role-user': !user?.admin, 'role-admin': user?.admin }" data-popupable-counter data-popupable-thumbnails>
    ...
    <script src="https://cdn.jsdelivr.net/npm/popupable@latest/dist/popupable.min.js"></script>
  </body>
</html>